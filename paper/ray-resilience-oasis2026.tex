% Ray Resilience — OASIS @ ACM SIGSPATIAL 2026, Track A short paper.
...
\title{Ray Resilience v0 --- An Accountable GeoAI System\\ for Place-Based Disaster Intelligence}
...
runs a spatial pipeline. Ray Resilience demonstrates \emph{accountability}: a
...
Ray Resilience locates it in the system. Following the framing of
...
Ray Resilience is three loosely coupled planes: a data plane (GitHub Actions
...
whereas Ray Resilience binds each sentence to a hashed artifact and a policy
...
\begin{acks}
Ray Resilience is an MIT-licensed research prototype. It is not an official
