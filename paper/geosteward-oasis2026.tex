% GeoSteward — OASIS @ ACM SIGSPATIAL 2026, Track A short paper.
...
\title{GeoSteward: An Accountable GeoAI Risk Analyst\\ That Declares Where Its Competence Ends}
...
runs a spatial pipeline. GeoSteward demonstrates \emph{accountability}: a
...
GeoSteward locates it in the system. Following the framing of
...
repository: \url{https://rayford295.github.io/GeoSteward/}} and reports
...
GeoSteward is three loosely coupled planes: a data plane (GitHub Actions
...
whereas GeoSteward binds each sentence to a hashed artifact and a policy
...
\begin{acks}
GeoSteward is an MIT-licensed research prototype. It is not an official
